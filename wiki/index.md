...
This index links the core knowledge base for **1 Human - 100 Agents - 1 Billion$**.
As the project grows, this file should point to the most important book, chapter, concept, example, framework, and claims pages.
...
- [Ronald Coase on the Firm](concepts/company/what-a-company-actually-is/ronald-coase-on-the-firm.md)
- [Oliver Williamson on the Firm](concepts/company/what-a-company-actually-is/oliver-williamson-on-the-firm.md)
- [Jensen and Meckling on the Firm](concepts/company/what-a-company-actually-is/jensen-and-meckling-on-the-firm.md)
- [Edith Penrose on the Firm](concepts/company/what-a-company-actually-is/edith-penrose-on-the-firm.md)
- [Alfred Chandler on the Firm](concepts/company/what-a-company-actually-is/alfred-chandler-on-the-firm.md)
...
- [Agent Architectures](concepts/agents/agent-architectures/index.md)
  - [The Perception-Reasoning-Action Loop](concepts/agents/agent-architectures/perception-reasoning-action-loop.md)
  - [Classical Agent Architectures](concepts/agents/agent-architectures/classical-agent-architectures.md)
  - [Modern LLM Agent Architectures](concepts/agents/agent-architectures/modern-llm-agent-architectures.md)
  - [Multi-Agent Systems](concepts/agents/agent-architectures/multi-agent-systems.md)
