...
Most founders cannot tell you what a company actually is. Ask ten of them and you get ten partial answers — a legal entity, a team, a product, a cap table, a brand. Each answer is partly right. None of them is enough to run on. This chapter gives you a single working model of what a company is, what it does, and why that matters if you plan to run one with a small team of humans and a large team of agents.

Let me introduce you to Hannah Schmidt. You will meet her many times in this book, so she is worth a page of your attention up front. Hannah is a computer scientist by training. She spent 4 years at a software agency in Munich, shipping other people's roadmaps and sitting through other people's status meetings. She was good at the job. She also knew, quietly, that the job was not going to be the thing.

The thing, for Hannah, was sewing. Not as a hobby — as a real fascination with fabric, construction, and the precision behind a well-made garment. Through a friend she wandered into the world of industrial sewing and tailoring machines. Large machines. Expensive machines. Machines that stitch pockets onto jeans at 3,000 stitches per minute and run production lines that cannot afford to stop. And the software running around those machines was, to her eye, embarrassing — fragmented, clunky, badly integrated, and held together by Excel and patience.

Hannah could not stop noticing the gap. She sketched out what the company would look like if she built it: software for industrial sewing and tailoring machines, a single German GmbH, a small technical team, and customers who would call her at 3 in the morning when a machine stopped stitching. She handed in her notice 1 month later. The agency sent flowers. Hannah started incorporating her company the same week.
